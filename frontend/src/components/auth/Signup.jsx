...
const Signup = ()=>{
    ...
    const handleSubmit= async (e)=>{
        ...
        console.log("signup successfull");
            ...
            dispatch(setError(serverMessage || "Signup Falied. Please try again "));
    ...
    return (
        <div className="signup-wrapper">
            ...
            <p className="signup-subtitle">
                Join us by today by entering the details
            </p>
            <form className="signup-form" onSubmit={handleSubmit}>
                <div>
                    <div className="profile-image-container">
                        {previewImage ? (
                            <img src={previewImage} alt="avatar" className="profile"/>
                        ) :(
                ...
                <span className="forgat-link" onClick={()=>{
                    dispatch(clearError());
