        ...
        if(showPasswordFields){
            ...
            try {
                const response = await axios.patch(
                    `${import.meta.env.VITE_BASE_URL}/api/auth/profile`,payload,
                    {
                        headers:{
    ...
    return (
        <div className="editprofile-wrapper">
            ...
            <form  className="editprofile-form" onSubmit={handleSubmit}>
                ...
                >{showPasswordFields ? "Cancel Password Change" : "Change Password"}</button>
                <div className="editprofile-actions">
                    <button
                        ...
                        disabled={isLoading}
                    >Cancel</button>
                    <button type="submit" className="editprofile-btn-submit">{isLoading ? "Saving..." : "Save Changes" }</button>
                </div>
            </form>
        </div>
    )
